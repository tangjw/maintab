package com.zonsim.maintab.util;

import android.util.Log;

import com.zonsim.maintab.BuildConfig;
...
public class Logg {
    ...
    public static void sout(String tag, Object anything) {
        if (isDebug) {
            System.out.println(tag + " => " + anything);
        }
    }
    
    public static void sout(Object anything) {
        if (isDebug) {
